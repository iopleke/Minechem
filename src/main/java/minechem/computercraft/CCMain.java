...
public class CCMain implements ICCMain
{
    ...
    public void init()
    {
        ...
        GameRegistry.addRecipe(new ItemStack(CCItems.chemistryUpgrade), "RRR", "RAR", "RRR", 'R', new ItemStack(Item.redstone), 'A', new ItemStack(MinechemItems.atomicManipulator));
    }
