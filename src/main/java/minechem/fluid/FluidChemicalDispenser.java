...
public class FluidChemicalDispenser implements IBehaviorDispenseItem
{
	...
	public ItemStack dispense(IBlockSource blockSource, ItemStack itemStack)
	{
		...
		} else
		{
			...
			} else if (itemStack.getItem() instanceof MoleculeItem && itemStack.getItemDamage() < MoleculeEnum.molecules.size())
			{
				block = FluidHelper.moleculeBlocks.get(FluidHelper.molecules.get(MoleculeEnum.molecules.get(itemStack.getItemDamage())));
			}
