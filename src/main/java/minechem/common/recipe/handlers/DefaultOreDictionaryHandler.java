...
public class DefaultOreDictionaryHandler implements OreDictionaryHandler
{
    ...
    {
        ModMinechem.LOGGER.log(Level.INFO, DefaultOreDictionaryHandler.class.getSimpleName() + " registered : " + event.Name);
        ...
        default:
            ModMinechem.LOGGER.log(Level.WARNING, DefaultOreDictionaryHandler.class.getSimpleName() + " : Invalid ore dictionary type.");
            break;
        }
