...
public class PharmacologyEffect
{
    ...
    { // This for the swords?
        EnumMolecule[] possibles =
        { EnumMolecule.water, EnumMolecule.starch, EnumMolecule.xylitol, EnumMolecule.sucrose, EnumMolecule.psilocybin, EnumMolecule.amphetamine, EnumMolecule.methamphetamine, EnumMolecule.mycotoxin, EnumMolecule.ethanol, EnumMolecule.cyanide,
                EnumMolecule.penicillin, EnumMolecule.testosterone, EnumMolecule.xanax, EnumMolecule.mescaline, EnumMolecule.asprin, EnumMolecule.shikimicAcid, EnumMolecule.phosgene, EnumMolecule.ttx, EnumMolecule.fingolimod, EnumMolecule.afroman,
                EnumMolecule.nod, EnumMolecule.hist, EnumMolecule.pal2, EnumMolecule.theobromine, EnumMolecule.retinol, EnumMolecule.glycine, EnumMolecule.alinine, EnumMolecule.serine, EnumMolecule.arginine, EnumMolecule.cocaine, EnumMolecule.cocainehcl,
                EnumMolecule.metblue, EnumMolecule.meoh, EnumMolecule.radchlor, EnumMolecule.caulerpenyne, EnumMolecule.latropine };
