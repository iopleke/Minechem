<<<<<<< HEAD:src/main/java/minechem/item/chemistjournal/PacketActiveJournalItem.java
...
public class PacketActiveJournalItem extends MinechemPackets
{
    ...
    public void execute(EntityPlayer player, Side side) throws ProtocolException
    {
        ...
        if (side.isServer())
        {
            ...
            if (journal != null && journal.itemID == MinechemItemGeneration.journal.itemID)
            {
                ...
                MinechemItemGeneration.journal.setActiveStack(activeStack, journal);
            }
        }
    }
...
>>>>>>> MaxwolfRewrite:src/main/java/minechem/item/chemistjournal/PacketActiveJournalItem.java
