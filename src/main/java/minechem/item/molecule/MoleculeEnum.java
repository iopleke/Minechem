...
public enum MoleculeEnum 
{
    ...
    mycotoxin(82, "T-2 Mycotoxin", 0.89F, 0.83F, 0.07F, 0.89F, 0.83F, 0.07F, new Element(C, 24), new Element(H, 34), new Element(O, 9)),
    ...
    retinol(95, "Retinol", new Element(C, 20), new Element(H, 29), new Molecule(hydroxide)),
    xylitol(96, "Xylitol", new Element(C, 5), new Element(H, 12), new Element(O, 5)),
    ...
    cocaine(100, "Cocaine", new Element(C, 17), new Element(H, 21), new Element(N), new Element(O, 4)),
    cocainehcl(101, "Cocaine Hydrochloride", new Molecule(cocaine), new Molecule(hcl)),
    ...
    caulerpenyne(110, "Caulerpenyne", new Element(C, 21), new Element(H, 26), new Element(O, 6)),
    ...
    MoleculeEnum(int id, String descriptiveName, float colorRed, float colorGreen, float colorBlue, float colorRed2, float colorGreen2, float colorBlue2, PotionChemical... chemicals) {
        this.id = id;
    ...
    MoleculeEnum(int id, String descriptiveName, PotionChemical... chemicals) 
    {
