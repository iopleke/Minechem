...
public class PharmacologyEffect {
    ...
    public static boolean givesEffect(EnumMolecule toTest) { // This for the swords?
        EnumMolecule[] possibles = {EnumMolecule.water, EnumMolecule.starch, EnumMolecule.xylitol, EnumMolecule.sucrose, EnumMolecule.psilocybin, EnumMolecule.amphetamine, EnumMolecule.methamphetamine, EnumMolecule.mycotoxin, EnumMolecule.ethanol, EnumMolecule.cyanide, EnumMolecule.penicillin, EnumMolecule.testosterone, EnumMolecule.xanax, EnumMolecule.mescaline, EnumMolecule.asprin, EnumMolecule.shikimicAcid, EnumMolecule.phosgene, EnumMolecule.ttx, EnumMolecule.fingolimod, EnumMolecule.afroman, EnumMolecule.nod, EnumMolecule.hist, EnumMolecule.pal2, EnumMolecule.theobromine, EnumMolecule.retinol, EnumMolecule.glycine, EnumMolecule.alinine, EnumMolecule.serine, EnumMolecule.arginine, EnumMolecule.cocaine, EnumMolecule.cocainehcl, EnumMolecule.metblue, EnumMolecule.meoh, EnumMolecule.radchlor, EnumMolecule.caulerpenyne, EnumMolecule.latropine};
     ...
     World world = entityPlayer.worldObj;
        switch (molecule) {
            ...
            case methamphetamine:
                ...
                break;
            case mycotoxin:
                entityPlayer.addPotionEffect(new PotionEffect(Potion.wither.getId(), Constants.TICKS_PER_SECOND * 120, 7));
                entityPlayer.addPotionEffect(new PotionEffect(Potion.weakness.getId(), Constants.TICKS_PER_SECOND * 120, 3));
                break;
            case ethanol:
                entityPlayer.addPotionEffect(new PotionEffect(Potion.confusion.getId(), Constants.TICKS_PER_SECOND * 30, 5));
                if (entityPlayer instanceof EntityPlayer) { ((EntityPlayer) entityPlayer).getFoodStats().addStats(1, .1F);}
                break;
            case cyanide:
            ...
            case testosterone:
                ...
                entityPlayer.addPotionEffect(new PotionEffect(Potion.moveSpeed.getId(), Constants.TICKS_PER_MINUTE * 3, 1));
                entityPlayer.addPotionEffect(new PotionEffect(Potion.damageBoost.getId(), Constants.TICKS_PER_MINUTE * 3, 1));
                break;
            case xanax:
            ...
            case hist:
                ...
                break;
            case pal2:
                entityPlayer.addPotionEffect(new PotionEffect(Potion.moveSlowdown.getId(), Constants.TICKS_PER_MINUTE * 1, 8));
                entityPlayer.addPotionEffect(new PotionEffect(Potion.wither.getId(), Constants.TICKS_PER_MINUTE * 1, 2));
                entityPlayer.addPotionEffect(new PotionEffect(Potion.confusion.getId(), Constants.TICKS_PER_MINUTE * 1, 2));
                break;
            case theobromine:
            ...
            case asparticAcid:
            case phenylalanine:
			 if (entityPlayer instanceof EntityPlayer) {((EntityPlayer) entityPlayer).getFoodStats().addStats(2, .1F);}
            ...
            case cocainehcl:
                ...
                break;
            case metblue:
                if (entityPlayer instanceof EntityPlayer) {cureAllPotions(world, (EntityPlayer) entityPlayer);}
