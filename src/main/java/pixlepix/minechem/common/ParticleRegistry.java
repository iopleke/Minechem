...
import pixlepix.minechem.common.entity.BlankParticle;
import pixlepix.minechem.common.entity.BlazepowderParticle;
import pixlepix.minechem.common.entity.CharcoalParticle;
import pixlepix.minechem.common.entity.ClayParticle;
import pixlepix.minechem.common.entity.CoalParticle;
import pixlepix.minechem.common.entity.ConcentratedParticle;
import pixlepix.minechem.common.entity.GlassParticle;
import pixlepix.minechem.common.entity.GunpowderParticle;
import pixlepix.minechem.common.entity.LeafParticle;
import pixlepix.minechem.common.entity.PaperParticle;
import pixlepix.minechem.common.entity.SandParticle;
import pixlepix.minechem.common.entity.SeedParticle;
import pixlepix.minechem.common.entity.SplitParticle;
...
public class ParticleRegistry {
    ...
    public static void registerEntities() {
        ...
        for (int i = 0; i < particles.size(); i++) {
            try {
                EntityRegistry.registerModEntity(particles.get(i), particles.get(i).getName(), i, ModMinechem.INSTANCE, 80, 1, true);
