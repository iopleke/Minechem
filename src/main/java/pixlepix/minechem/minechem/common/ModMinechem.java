...
import pixlepix.minechem.minechem.client.TickHandler;
import pixlepix.minechem.minechem.client.gui.tabs.TabEnergy;
import pixlepix.minechem.minechem.client.gui.tabs.TabHelp;
import pixlepix.minechem.minechem.client.gui.tabs.TabJournel;
import pixlepix.minechem.minechem.client.gui.tabs.TabStateControl;
import pixlepix.minechem.minechem.client.gui.tabs.TabStateControlSynthesis;
import pixlepix.minechem.minechem.client.gui.tabs.TabTable;
import pixlepix.minechem.minechem.common.blueprint.MinechemBlueprint;
import pixlepix.minechem.minechem.common.coating.CoatingRecipe;
import pixlepix.minechem.minechem.common.coating.CoatingSubscribe;
import pixlepix.minechem.minechem.common.coating.EnchantmentCoated;
import pixlepix.minechem.minechem.common.gates.MinechemTriggers;
import pixlepix.minechem.minechem.common.network.PacketHandler;
import pixlepix.minechem.minechem.common.polytool.PolytoolEventHandler;
import pixlepix.minechem.minechem.common.recipe.ConfigurableRecipies;
import pixlepix.minechem.minechem.common.recipe.MinechemRecipes;
import pixlepix.minechem.minechem.common.utils.ConstantValue;
import pixlepix.minechem.minechem.computercraft.ICCMain;
import pixlepix.minechem.minechem.fluid.FluidHelper;
...
// import pixlepix.minechem.minechem.common.plugins.BOPModule;
...
public class ModMinechem {
    ...
    @SidedProxy(clientSide = "pixlepix.minechem.minechem.client.ClientProxy", serverSide = "pixlepix.minechem.minechem.common.CommonProxy")
	...
	private void initComputerCraftAddon(FMLPostInitializationEvent event) {
        Object ccMain = event.buildSoftDependProxy("CCTurtle", "pixlepix.minechem.minechem.computercraft.CCMain");
        if (ccMain != null) {
