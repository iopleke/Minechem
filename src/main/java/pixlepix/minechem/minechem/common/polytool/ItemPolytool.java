...
import pixlepix.minechem.minechem.common.GuiHandler;
...
public class ItemPolytool extends ItemPickaxe implements IEnergyContainerItem {
	...
	public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
		...
		ensureNBT(par1ItemStack);
		addTypeToNBT(par1ItemStack, PolytoolHelper.getTypeFromElement(EnumElement.C, 5));
		 */
