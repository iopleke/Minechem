...
import pixlepix.minechem.minechem.common.blueprint.BlueprintBlock.Type;
import pixlepix.minechem.minechem.common.blueprint.MinechemBlueprint;
import pixlepix.minechem.minechem.common.sound.LoopingSound;
import pixlepix.minechem.minechem.common.utils.LocalPosition;
import pixlepix.minechem.minechem.common.utils.LocalPosition.Pos3;
...
public class TileEntityBlueprintProjector extends MinechemTileEntity {
    ...
    public TileEntityBlueprintProjector() {
        this.projectorSound = new LoopingSound("pixlepix.minechem.minechem.projector", 20);
